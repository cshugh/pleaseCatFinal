<template>
  <div id="catProfile" v-if="selectedCat">
    ...
    <div id="photoView">
      ...
      <div id="man" v-if="catManager">
        <router-link :to="`/userProfile/${this.rankList[0].user_no}`">
          ...
          <img
            id="manPhoto"
            :src="require(`../../assets/images/man/${this.rankList[0].user_no}.jpg`)"
            alt
          />
    ...
    <div id="descView" class="text">
      ...
      <span id="updateTime">
        <button v-onclick="catBob()"><img id="catBobImg" :src="require(`../../assets/images/icons/catBob.png`)" /></button>
      </span>
    </div>
    <div id="mapView">
    ...
    <div id="rankView" v-if="rankList">
      <div
        id="rankIcon"
        class="circle"
        :style="{'background-image' : `url(${require('@/assets/images/icons/rankIcon.jpg')})`}"
        alt="rank"
      ></div>
      <RankComponent
        ...
        :key="idx"
        :ranking="idx+1"
        :user_no="rank.user_no"
        :score="rank.rank_point"
        :name="rank.user_id"
      />
